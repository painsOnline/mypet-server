...
INSERT INTO c_tenant (id, database_instance_id, free_shipping_amount, is_disable, create_time)
VALUES ('00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 20.00, 0, now()::timestamp(0))
ON CONFLICT (id) DO NOTHING;
